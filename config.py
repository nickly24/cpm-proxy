...
MAIN_SERVER_URL = os.environ.get('MAIN_SERVER_URL', 'https://nickly24-cpm-serv-9333.twc1.net')

# URL экзам сервера (cpm-exam-main)
EXAM_SERVER_URL = os.environ.get('EXAM_SERVER_URL', 'https://nickly24-cpm-exam-main-abaa.twc1.net/')
